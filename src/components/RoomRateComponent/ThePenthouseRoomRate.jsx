    ...
    <div className="p-6 bg-white space-y-4">
      ...
      <div className="pt-4 space-y-2">
        <div className="flex items-center space-x-2 text-red-700">
          ...
          <span className="text-sm text-gray-600">10% Off Saving on The Penthouse </span>
        </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <div className="flex flex-col items-center"> {/* Changed to flex-col */}
            <span className="text-sm line-through text-gray-500 ml-10">$256</span> {/* Original price above */}
            <div className="flex items-center space-x-2">
              <span className="bg-red-700 text-white text-xs font-semibold px-2 py-1 rounded">Sale</span>
              <span className="text-2xl font-bold text-red-700">$189</span> {/* Discounted price below */}
            </div>
          </div>
...
export default ThePenthouseRoomRate;
