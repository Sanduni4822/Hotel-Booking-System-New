      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <div className="flex flex-col items-center"> {/* Changed to flex-col */}
            <span className="text-sm line-through text-gray-500 ml-10">$205</span> {/* Original price above */}
            <div className="flex items-center space-x-2">
              <span className="bg-red-700 text-white text-xs font-semibold px-2 py-1 rounded">Sale</span>
              <span className="text-2xl font-bold text-red-700">$185</span> {/* Discounted price below */}
            </div>
          </div>
